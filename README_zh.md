...
[English Version (README.md)](README.md) | **简体中文**
...
1. **GitHub Issues**（推荐）：
   - 对于一切代码缺陷、特性建议、运行报错，请前往项目的 [Issues](https://github.com/GoldBean216/toontalk-ai/issues) 页面提交。我们会在第一时间进行跟进与探讨。
2. **Pull Requests**：
   - 如果您已经完成了某项修复或特性开发，请直接提交 [PR](https://github.com/GoldBean216/toontalk-ai/pulls)。
